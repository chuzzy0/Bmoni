...
export default function Features() {
  return (
    <section id="features" className="bg-[#f3f4ff] py-20 sm:py-24">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {features.map((feature) => {
            ...
            return (
              <article
                key={feature.title}
                className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200/70 transition hover:-translate-y-1 hover:shadow-xl hover:shadow-violet-900/5"
              >
